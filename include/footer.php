<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/logo-white.png" alt="image" style="width: 150px; height: 150px;"></a> </div>
                                        <p class="pb-20 text-white">HomeHarbor: Navigating Your Dreams to Reality</p>
                                        <p class="pb-20 text-white">Discover Your Ideal Home Journey with Us</p>
                                        <p class="pb-20 text-white">Unlock the Door to Dream Living.</p>
                                        <p class="pb-20 text-white">Your Gateway to Home Happiness.</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Dhaka, Dhaka 1015, Bangladesh</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+017******</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+019*******</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>***@***</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2023 HomeHarbor All right reserved</span> </div>
                    <div class="col-sm-6">
